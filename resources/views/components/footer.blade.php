<footer class="py-4" style="background-color: #73C1FF; color: #00579D;">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <img src="{{ asset('assets/logo-footer.png') }}" alt="" width="120">
                <p class="mb-0" style="font-weight: 500;">Jurusan terbaik versi kamu, hanya di Campustar!</p>
            </div>
