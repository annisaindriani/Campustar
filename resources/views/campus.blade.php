            ...
            <div class="row row-cols-1 row-cols-md-4 g-4 mt-2">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/unpad.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">NEGERI</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo unpad.png') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/ciputra.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">SWASTA</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo uc.jpeg') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/sanata dharma.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">SWASTA</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo sanata dharma.png') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/uph.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">SWASTA</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo uph.jpg') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/airlangga.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">NEGERI</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo unair.png') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/unsri.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">NEGERI</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo unsri.png') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/gunadarma.jpeg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">SWASTA</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo gundar.png') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/telkom.jpeg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">SWASTA</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo telkom.png') }}" class="card-img-top" alt="..." style="width: 50px;">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/itb.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">NEGERI</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                ...
                <div class="col">
                    <a href="" class="text-decoration-none">
                        <div class="card kampus">
                            <div class="position-relative" style="height: 160px;">
                                <img src="{{ asset('assets/kampus/atmajaya.jpg') }}" class="card-img-top" alt="..." style="height: 160px;">
                                <button type="button" class="btn btn-secondary button-status" style="position: absolute; bottom: 10px; left: 10px;">SWASTA</button>
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('assets/kampus/logo atmajaya.png') }}" class="card-img-top" alt="..." style="width: 50px;">
